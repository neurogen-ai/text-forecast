...
Implements `plans/releases/2.3.md`. Refined against the code as of plan 2.1 T5
...
**Depends on documents:** `plans/releases/2.3.md` (the spec),
...
## Deviations from plans/releases/2.3.md found during inspection
...
the trivial wrappers. No logic change. Spec: `plans/releases/2.3.md` §2.1, §2.3.
...
`[runtime.modal]` via `modal_runtime_config`. Spec: `plans/releases/2.3.md` §2.3.
...
it from all three current sites. Spec: `plans/releases/2.3.md` §2.4, extended to cover
...
the identical message text. Spec: `plans/releases/2.3.md` §2.5, updated for the sites
...
updating plans/releases/2.3.md itself.
