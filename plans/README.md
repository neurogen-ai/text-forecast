...
| Plan | Title | Status |
|------|-------|--------|
| [2.1](2.1.md) | Clean pipeline refactor: ordered step specs, per-column intensity controls, nested CLI | drafted, not started |
| [2.2](2.2.md) | Modal runtime tidy-up: dedupe config/log noise, inline wrappers, single-source EVAL naming | drafted, not started |
