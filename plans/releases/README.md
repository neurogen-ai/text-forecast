...
| [2.5](2.5.md) | Modal runtime tidy-up: dedupe config/log noise, inline wrappers, single-source EVAL naming; also carries the preprocess id-skip resume slice (proposal v2.11), the eval-compile/tokenise-path fixes from the 2026-09 audit, and Gumbel random-selection knobs (random proportion + tau; subsumes the rejected v2.10 random-share proposal) | drafted; [implementation plan](implementation/v2.5.md) written (branches A–F), not started; T8 in progress on branch `v2.5-retrieval-forecastB` |
...
| [2.9](2.9.md) | CLI launch speed: lazy heavy imports, torch-free modal client paths | drafted; [implementation plan](implementation/v2.9.md) written (branches A–E), not started |
