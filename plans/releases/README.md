...
| [2.4](2.4.md) | Modal runtime tidy-up: dedupe config/log noise, inline wrappers, single-source EVAL naming | drafted; [implementation plan](implementation/v2.4.md) written (branches A–F), not started |
| [2.5](2.5.md) | Production deployment hardening | not started |
| [2.6](2.6.md) | Distributed GPU training/eval | not started |
| [2.7](2.7.md) | Remote progress tracking for cloud runs | reconstructed after file loss; review before executing (references renumbered 2.5/2.6) |
